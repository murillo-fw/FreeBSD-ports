...
$pgtitle = array(gettext("Package"), gettext("Services: E2guardian"),
    gettext("About"));
...
$tab_array[] = array(gettext("Daemon"), false,
    "/pkg_edit.php?xml=e2guardian.xml&id=0");
$tab_array[] = array(gettext("General"), false,
    "/pkg_edit.php?xml=e2guardian/e2guardian_config.xml&id=0");
$tab_array[] = array(gettext("Limits"), false,
    "/pkg_edit.php?xml=e2guardian/e2guardian_limits.xml&id=0");
$tab_array[] = array(gettext("Blacklist"), false,
    "/pkg_edit.php?xml=e2guardian/e2guardian_blacklist.xml&id=0");
$tab_array[] = array(gettext("ACLs"), false,
    "/pkg.php?xml=e2guardian/e2guardian_site_acl.xml");
$tab_array[] = array(gettext("LDAP"), false,
    "/pkg.php?xml=e2guardian/e2guardian_ldap.xml&id=0");
$tab_array[] = array(gettext("Groups"), false,
    "/pkg.php?xml=e2guardian/e2guardian_groups.xml&id=0");
$tab_array[] = array(gettext("Users"), false,
    "/pkg_edit.php?xml=e2guardian/e2guardian_users.xml&id=0");
$tab_array[] = array(gettext("IPs"), false,
    "/pkg_edit.php?xml=e2guardian/e2guardian_ips.xml&id=0");
$tab_array[] = array(gettext("Real Time"), false,
    "/e2guardian/e2guardian_monitor.php");
$tab_array[] = array(gettext("Report and Log"), false,
    "/pkg_edit.php?xml=e2guardian/e2guardian_log.xml&id=0");
$tab_array[] = array(gettext("Sync"), false,
    "/pkg_edit.php?xml=e2guardian/e2guardian_sync.xml&id=0");
$tab_array[] = array(gettext("Help"), true,
